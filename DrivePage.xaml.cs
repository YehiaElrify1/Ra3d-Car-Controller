...
public partial class DrivePage : ContentPage
{
    ...
    private async void OnLeftPressed(object sender, EventArgs e) => await App.SendCommand("R");
    private async void OnRightPressed(object sender, EventArgs e) => await App.SendCommand("L");
